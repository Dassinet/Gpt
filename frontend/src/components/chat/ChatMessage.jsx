...
const ChatMessage = ({ 
  ...
  return (
    <div className="w-full p-2 sm:p-4 bg-white dark:bg-black">
      ...
      {isUploading && (
        <div className="mb-4">
          <div className="flex items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800/30">
            ...
            <div className="flex-1 min-w-0">
              ...
              <Progress 
                ...
                className="h-2 bg-blue-100 dark:bg-blue-800/40"
              />
        ...
        <div className="mb-4">
          <div className="flex flex-wrap gap-2">
            {uploadedFiles.map((file, index) => (
              <div
                key={`${file.name}-${index}`}
                className="flex items-center gap-2 py-2 px-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700/50 max-w-fit"
              >
                ...
                <button
                  ...
                  className="ml-1 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-colors"
            ...
            <div className="flex justify-between items-center mt-1.5 sm:mt-2">
              <div className="flex items-center">
                ...
                <button
                  ...
                  className={`text-gray-400 dark:text-gray-500 rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-colors ${(isLoading || disabled) ? 'cursor-not-allowed opacity-50' : ''}`}
                ...
                {showWebSearchIcon && (
                  ...
                  >
                    {webSearchEnabled ? 
                      <BsGlobe2 size={16} className="sm:text-[18px] text-green-600 dark:text-green-400" /> : 
                      <BsGlobe2 size={16} className="sm:text-[18px] text-gray-400 dark:text-gray-500" />
                    }
                  </button>
                )}
              </div>
              ...
              <button
                type="submit"
                className={`rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center transition-all duration-200 ${(!inputMessage.trim() || isLoading || disabled)
